...
public class ClientHandler {
    ...
    public ClientHandler(Socket socket, ChatServer chatServer) {
        ...
        try {
            ...
            throw new ChatServerException("Something went wrong during chat_server.client establishing.", e);
        }
    ...
    private void doAuthentication() throws IOException {
        ...
        while (true) {
            try {
                ...
                throw new ChatServerException("Something went wrong during chat_server.client authentication.", e);
            }
        }
    }
